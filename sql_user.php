...
/****************************************************
  ...
  @param string|null $tablename 検索対象のテーブル名
  @param array|string|null $fields 取得するカラム名。nullで全カラム
  @param array|string|null $keyword 検索条件。スペースでOR検索
  @param string|null $orderby 並び順（例："id DESC", "name ASC"）
 ****************************************************/
